        ...
        <div>
          ...
          <div className="mt-10 flex flex-col gap-10 pb-16 md:mt-16">
            <div className="flex flex-col gap-12 md:flex-row md:gap-24">
              <div className="text-sm text-zinc-900 md:mt-3 dark:text-zinc-300">
                2023
              </div>
              <div className="flex flex-col gap-1 md:mx-3">
                {allBlogs[2023].map((blog, index) => (
                  ...
                  >
                    <h2 className="text-sm font-bold text-zinc-900 dark:text-zinc-300">
                      {blog.title}
                    </h2>
                    <p className="mt-1.5 text-xs text-zinc-700 dark:text-zinc-400">
                      {blog.description}
                    </p>
                  </AppLink>
                ))}
