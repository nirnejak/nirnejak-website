  ...
  return (
    <main className="max-w-[100vw] overflow-hidden">
      ...
      <section className="container mt-10 mb-16 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2">
        <div>
          <p className="font-medium text-sm text-zinc-500">Computer</p>
          <p className="mt-1.5 font-semibold text-lg text-zinc-300">
            iPad Pro 11, MacBook Air & <br />
            Apple Studio Display
          </p>
        </div>
        <div>
          <p className="font-medium text-sm text-zinc-500">Camera & Gear</p>
          <p className="mt-1.5 font-semibold text-lg text-zinc-300">
        ...
        <div>
          <p className="font-medium text-sm text-zinc-500">Audio</p>
          <p className="mt-1.5 font-semibold text-lg text-zinc-300">
        ...
        <div>
          <p className="font-medium text-sm text-zinc-500">Accessories</p>
          <p className="mt-1.5 font-semibold text-lg text-zinc-300">
        ...
        <div>
          <p className="font-medium text-sm text-zinc-500">Design Tools</p>
          <p className="mt-1.5 font-semibold text-lg text-zinc-300">
